 ...
 *
 */
class CacheMenuItem extends AbstractItem
{

    const CLASS_HTML = "combo-cache-item";
    ...
    {
        return "Show the cache results";
    }

    public function getSvg(): string
    {
        /** @var string icon file */
        return DirectoryLayout::getComboImagesDirectory()->resolve('mdi-cache.svg')->toQualifiedPath();
    }
