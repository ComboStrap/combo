...
require_once(__DIR__ . '/MetadataInteger.php');
...
require_once(__DIR__ . '/ConditionalLength.php');
require_once(__DIR__ . '/ConditionalValue.php');
require_once(__DIR__ . '/Console.php');
require_once(__DIR__ . '/ContextManager.php');
...
require_once(__DIR__ . '/PageLevel.php');
...
require_once(__DIR__ . '/TreeSystem.php');
require_once(__DIR__ . '/TreeVisit.php');
