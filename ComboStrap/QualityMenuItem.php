...
class QualityMenuItem extends AbstractItem
{
    ...
    public function getSvg(): string
    {
        ...
        if ($this->page->isLowQualityPage()) {
            ...
            return DirectoryLayout::getComboImagesDirectory()->resolve( 'quality-alert.svg')->toAbsoluteString();
        } else {
            /**
             * @var string icon file
             * !!! Same icon used in the landing page !!!
             */
            return DirectoryLayout::getComboImagesDirectory()->resolve('quality.svg')->toAbsoluteString();
        }
    }
