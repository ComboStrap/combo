                ...
                for (const metadata in jsonMetaDataObject) {
                    if (jsonMetaDataObject.hasOwnProperty(metadata)) {
                        ...
                        if (metadataValues !== undefined) {
                            ...
                            let htmlPlaceholder = `placeholder="${metadataDefault}"`;
                            let htmlValue = "";
                            ...
                            switch (htmlTag) {
                                case "textarea":
                                    htmlElement = `<textarea id="${id}" class="${htmlClass}" rows="3" ${htmlPlaceholder} >${htmlValue}</textarea>`;
                                    break;
                                default:
                                case "input":
                                    htmlElement = `<input type="${inputType}" class="${htmlClass}" id="${id}" ${htmlPlaceholder} ${htmlValue} ${checked} ${disabled}>`;
                                    break;
