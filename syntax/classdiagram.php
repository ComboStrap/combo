 ...
 *
 * The parser rules:
 * https://github.com/mermaid-js/mermaid/blob/develop/src/diagrams/class/parser/classDiagram.jison
 */
class syntax_plugin_combo_classdiagram extends DokuWiki_Syntax_Plugin
{


    const TAG = 'classdiagram';
    const MARKUP = 'class-diagram';
