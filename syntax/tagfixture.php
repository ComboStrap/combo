 ...
 * This is not public
 *
 * @deprecated {@link Tag} is deprecated
 */
class syntax_plugin_combo_tagfixture extends DokuWiki_Syntax_Plugin
{
    ...
    function handle($match, $state, $pos, Doku_Handler $handler)
    {
        ...
        switch ($state) {
            ...
            case DOKU_LEXER_ENTER :
                ...
                $attributes['data-parent'] = $tag->getParent()->getName();;
                $attributes['data-parent-type'] = $tag->getParent()->getType();;
                $attributes['data-child-of-blockquote'] = $tag->isChildOf("blockquote");
                $attributes['data-descendant-of-card'] = $tag->isDescendantOf("card");
                $attributes['data-has-siblings'] = $tag->hasSiblings();
                $attributes['data-first-sibling'] = $tag->getPreviousSibling() !== null ? $tag->getPreviousSibling()->getName() : false;
