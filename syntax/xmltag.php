...
class syntax_plugin_combo_xmltag extends DokuWiki_Syntax_Plugin
{
    ...
    private static function renderStaticExitXhtml(TagAttributes $tagAttributes, Doku_Renderer_xhtml $renderer, array $data, DokuWiki_Syntax_Plugin $plugin)
    {
    ...
    private static function renderStaticEnterXhtml(TagAttributes $tagAttributes, Doku_Renderer_xhtml $renderer, array $data, DokuWiki_Syntax_Plugin $plugin): bool
    {
    ...
    private static function handleStaticExit(string $match, int $pos, Doku_Handler $handler, DokuWiki_Syntax_Plugin $plugin): array
    {
    ...
    private static function handleStaticEnter(string $match, int $pos, Doku_Handler $handler, DokuWiki_Syntax_Plugin $plugin): array
    {
        // context data
            ...
            case "xhtml":
                ...
                switch ($state) {
                    ...
                    case DOKU_LEXER_EXIT:
                        ...
                        return self::renderStaticExitXhtml($tagAttributes, $renderer, $data, $plugin);
                }
                break;
            case 'metadata':
